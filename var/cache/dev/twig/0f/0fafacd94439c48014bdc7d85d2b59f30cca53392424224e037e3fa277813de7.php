...
class __TwigTemplate_b41b4f4c1cf8d9670118f234d6fb54a79db5b3314ddebe967a6ba9873bae0ea1 extends Template
{
    ...
    ";
        ...
        echo "\" class=\"btn btn-large waves-effect waves-light grey col s12\">Annuler</a>
                            ...
                            ";
        // line 41
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 41, $this->source); })()), "statut", [], "any", false, false, false, 41), 'widget');
        echo "
                            <div class=\"input-field col s12 l6\">
                                <button class=\"btn btn-large waves-effect waves-light pink lighten-1 col s12\" type=\"submit\" name=\"action\" value=\"btnStripe\">
                                    Payer
...
";
    ...
    {
        return array (  162 => 61,  152 => 60,  132 => 48,  122 => 41,  117 => 39,  112 => 36,  103 => 29,  95 => 24,  86 => 18,  72 => 6,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "landing_page/partials/stripe.html.twig", "/shared/httpd/NerfShop/templates/landing_page/partials/stripe.html.twig");
    }
}
